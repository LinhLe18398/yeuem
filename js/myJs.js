const textConfig = {
  text1: "He luu Diệu Anh!",
  text2: "Anh có điều này muốn hỏi em nhớ phải trả lời thật lòng nhaaa.",
  text3: "Diệu Anh yêu Linh Lê có phải không nào ._.",
  ...
  text11:
    "Tối nay Anh qua đón cậu đi chơi nhaa :v Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàooo",
  text12: "Okii lunn <3",
};
